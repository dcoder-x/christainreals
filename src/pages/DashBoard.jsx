        ...
        <main id="bump-up" style={{display:show==true?'flex':'none'}}>
            <section className='bumpUp-holder'>
                <div className="bump-modal">
                    ...
                    <p className="desc">
                        Are you not getting enough messages, smiles, likes or waves 
                        from other members? It could be because your profile is not 
                        easily visible to others. Just as in any database, as 
                        membership increases, people may find themselves being pushed 
                        towards the bottom of the list in a search result. To ensure 
                        that they stay in the top of any search result so they can be 
                        seen easily and contacted by potential matches, premium members 
                        can pay a small fee of £7 to be bumped up for 28 days from 
                        the date of payment. A lot can happen in 28 days, you know!
                    </p>
    ...
    <main id="dashboard">
        <div className="sideBar">
            <div className="profile">
                ...
                <div className="bumpUp" onClick={e=>{setshow(true)}}>
            ...
            <div className="menu-holder">
                {
                    sideMenu.map(menu=>{
                        return(
                            <div className="menu" onClick={e=>{navigate(menu.link)}}>
        ...
        <BumpUp show={show} onclose={e=>{setshow(false)}}/>
    </main>
  )
}
