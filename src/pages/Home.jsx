  ...
  return (
    <main id="home" style={{ marginTop: "5rem" }}>
      ...
      <section className="intro">
        <div className="intro-text">
          ...
          <p>
            ...
            Then you have come to the right place! Here, you can meet real
            single Christians of all ages and backgrounds for relationship,
            dating and marriage; and you can also enjoy social networking and
            personal development activities and events all in one place.
          </p>
        </div>
        <div className="vid">
          ...
          <iframe
            width="560"
            height="315"
            src="https://www.youtube-nocookie.com/embed/G4xYq3PnHEo?start=6"
      ...
      {sectionData.map((data) => {
        return (
          <HomeSection
            sectionBg={data.bgImage}
            sectionText={data.desc}
